...
class StockfishAnalyzer {
  ...
  evaluateMoveQuality(beforeAnalysis, afterAnalysis, move) {
    ...
    // Use the original working logic (that worked for White moves)
    // Apply it consistently regardless of which color the move is
    const beforeEval = this.evaluationToCentipawns(beforeAnalysis.evaluation, move.color === 'w');
    const afterEval = this.evaluationToCentipawns(afterAnalysis.evaluation, move.color === 'b');
