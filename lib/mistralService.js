...
class MistralService {
    constructor() {
        ...
        this.model = 'mistral-medium'; // Balanced performance and cost for chess analysis
        this.maxTokens = 1500; // Optimized for Mistral Medium chess analysis
    ...
    async sendChatMessage(messages) {
        ...
        const requestData = {
            ...
            temperature: 0.3, // Lower temperature for more focused and consistent chess analysis
            stream: false
        };
